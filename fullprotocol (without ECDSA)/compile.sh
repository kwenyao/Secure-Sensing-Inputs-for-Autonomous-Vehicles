...
OTHER_C_FILES="tpm.c base64.c aes.c socket.c serialization.c certificate.c fileio.c"
...
gcc gencsr.c $OTHER_C_FILES $INCLUDE_DIR $LIBRARY_DIR $LIBRARIES $GCC_OPTIONS -o gencsr.exe

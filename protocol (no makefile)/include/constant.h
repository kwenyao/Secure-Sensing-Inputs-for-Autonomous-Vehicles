...
#define OTHER_KEY_UUID {0,0,0,0,0,{0,0,0,2,9}}
...
//MESSAGE
#define ENCRYPTED_MSG_LENGTH_LENGTH 4 // size of uint32_t in bytes
...
#define MSG_NO_DATA_LENGTH UINT_LENGTH + ECC_SIGNATURE_LENGTH + TAG_LENGTH + ENCRYPTED_MSG_LENGTH_LENGTH

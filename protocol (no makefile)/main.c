...
int main(){
	...
	*******************************/
	...
	if(isVerified(tpm.hContext, signature, SIGNATURE_LENGTH, nonceA, NONCE_LENGTH)){
		...
		// pubKey = CreateBindKey(hContext, hSRK, &pubKeyLength);5
